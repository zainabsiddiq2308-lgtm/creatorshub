...
const Nav = () => {
  return (
    <div className="mt-20 bg-gray-800 text-white w-full overflow-x-hidden">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center px-6 py-6 gap-4 flex-wrap">
        ...
        {/* Contact Info */}
        <div className="flex flex-col md:flex-row md:items-center md:space-x-6 text-center md:text-left gap-2 text-sm md:text-base break-words">
          ...
          <Link
            href="mailto:thecreatorHub234@gmail.com"
